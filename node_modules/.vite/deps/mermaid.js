import { B as select_default, H as __name, U as log, W as setLogLevel } from "./src-CXzfqqM4.js";
import { F as reset, G as setSiteConfig, H as setConfig, J as styles_default, M as registerDiagram, N as registerLazyLoadedDiagrams, S as getDiagramLoader, T as getSiteConfig, X as updateSiteConfig, Y as themes_default, Z as purify, c as configureSvgSize, f as detectType, g as frontMatterRegex, h as evaluate, l as defaultConfig, n as addDirective, p as detectors, r as assignWithDepth_default, t as UnknownDiagramError, w as getEffectiveHtmlLabels, x as getDiagram, y as getConfig, z as saveConfigFromInitialize } from "./chunk-ICPOFSXX-Bt4FoXkh.js";
import { a as encodeEntities, d as isDetailedError, h as utils_default, i as decodeEntities, m as removeDirectives, r as cleanAndMerge } from "./chunk-5PVQY5BW-VeMwJJEw.js";
import { t as selectSvgElement } from "./chunk-426QAEUC-DzHnTigQ.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-AywH7d0s.js";
import "./chunk-BSJP7CBP-B8sRcqEd.js";
import "./chunk-ZZ45TVLE-DdRqqbiW.js";
import "./chunk-X2U36JSP-DMKNS72S.js";
import { i as registerIconPacks, o as dedent } from "./chunk-U2HBQHQK-BrK0I7NG.js";
import "./chunk-5FUZZQ4R-_8oZbffn.js";
import "./chunk-ENJZ2VHE-DisnvH9N.js";
import { n as registerLayoutLoaders } from "./chunk-336JU56O-BzltZwbE.js";
import { t as isEmpty } from "./isEmpty-DLK7pTlF.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-AHTNJAMY-DY6oau94.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-DWJPFMVM-CrTHFawF.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-SMLLAGMA-DjGV3Uc4.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-UUTBAWPF-BTmJRE5c.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-T4ZO3ILL-B4iyD5bC.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-42DDH7IO-D4WsNm12.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-DEJITSTG-BvOc-w3u.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-34T5L4WZ-DD2_QpDo.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-5P7HB3ND-BPkV0K1S.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-MS252O5E-Dt4pcDrS.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-FGHM5R23-DwK2qPV1.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-6PBFFD2Q-Cf9Ashnn.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-HSJHXN6E-W02WVric.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-FHFEXIEX-twl6VVyY.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-QKLJ7IA2-CHI4v0iM.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-VCZTEJTY-BOmbNr_i.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var renderer = { draw: /* @__PURE__ */ __name((_text, id32, version) => {
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-GMOUNBTQ-b96qSeXy.js");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-QFDTVHPH-BbkVn39w.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-6JOO6SKY-C-Wxv3FU.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-XADWPNL6-DCgqjI6q.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-TYMM5635-DJlK_52v.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-MMDJMWI5-DkwE39JX.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-DXYQGD6D-CA-nAlMc.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-5BDNPKRD-Bi4iZ8eu.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-Q4EWVU46-X8jZ4X5y.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-UXIWVN3A-Z8RyeWlF.js");
		return {
			id: id28,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-DHZGUBPP-DhhVi3Tp.js");
		return {
			id: id29,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-G4DWMVQ6-C-Fya5vP.js");
		return {
			id: id30,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-NUSXRM2D-Dbfd0rZn.js");
		return {
			id: id31,
			diagram: diagram2
		};
...
var loadRegisteredDiagrams = /* @__PURE__ */ __name(async () => {
	...
	const failed = (await Promise.allSettled(Object.entries(detectors).map(async ([key, { detector: detector32, loader: loader32 }]) => {
		if (!loader32) return;
		try {
			getDiagram(key);
		} catch {
...
var Diagram = class _Diagram {
	...
	static async fromText(text, metadata = {}) {
		...
		try {
			...
			if (!loader32) throw new UnknownDiagramError(`Diagram ${type} not found.`);
...
var createUserStyles = /* @__PURE__ */ __name((config, graphType, classDefs, svgId) => {
	return serialize(compile(`${svgId}{${styles_default(graphType, createCssStyles(config, classDefs), {
...
var render = /* @__PURE__ */ __name(async function(id32, text, svgContainingElement) {
	addDiagrams();
	...
	try {
		...
		else errorRenderer_default.draw(text, id32, "11.14.0");
		throw e;
	}
...
var runThrowsErrors = /* @__PURE__ */ __name(async function({ postRenderCallback, querySelector, nodes } = { querySelector: ".mermaid" }) {
	...
	for (const element of Array.from(nodesToProcess)) {
		...
		try {
			...
			if (postRenderCallback) await postRenderCallback(id32);
...
var render2 = /* @__PURE__ */ __name((id32, text, container) => {
	return new Promise((resolve, reject) => {
		const performCall = /* @__PURE__ */ __name(() => new Promise((res, rej) => {
			mermaidAPI.render(id32, text, container).then((r) => {
				res(r);
				resolve(r);
			}, (e) => {
				log.error("Error parsing", e);
...
var mermaid = {
	...
	getRegisteredDiagramsMetadata: /* @__PURE__ */ __name(() => {
		return Object.keys(detectors).map((id32) => ({ id: id32 }));
