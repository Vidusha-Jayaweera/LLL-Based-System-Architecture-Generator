...
import { B as setAccDescription, C as getDiagramTitle, L as sanitizeText, V as setAccTitle, W as setDiagramTitle, _ as getAccDescription, a as clear, b as getConfig2$1, c as configureSvgSize, v as getAccTitle } from "./chunk-ICPOFSXX-Bt4FoXkh.js";
...
//#region node_modules/mermaid/dist/chunks/mermaid.core/wardleyDiagram-NUSXRM2D.mjs
...
function updateAxes(partial) {
	const sanitized = {};
	if (partial.xLabel) sanitized.xLabel = textSanitizer(partial.xLabel);
	if (partial.yLabel) sanitized.yLabel = textSanitizer(partial.yLabel);
	if (partial.stages) sanitized.stages = partial.stages.map((stage) => textSanitizer(stage));
	if (partial.stageBoundaries) sanitized.stageBoundaries = partial.stageBoundaries;
...
//# sourceMappingURL=wardleyDiagram-NUSXRM2D-Dbfd0rZn.js.map